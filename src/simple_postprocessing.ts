...
const changedColorNode = scenePassColor.mul(vec4(-1,-1,-1,1)).add(vec4(1,1,1,0));
// const changedColorNode = invert(scenePassColor);

// const changedColorNode = invert(scenePassColor);
// changedColorNode.w=1.0;


postProcessing.outputNode=changedColorNode;
